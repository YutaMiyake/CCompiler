#include "ast_node.h"
struct_declaration_list_node::struct_declaration_list_node(): ast_node(){
}
struct_declaration_list_node::struct_declaration_list_node(struct_declaration_node* child): ast_node(){
  addStrDecl(child);
}
void struct_declaration_list_node::addStrDecl(struct_declaration_node* child){
...
std::string struct_declaration_list_node::generateCode(){
  return "";
}